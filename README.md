...
<span style="white-space: nowrap;">hover-freeze</span> | First click enables hover mode, second click freezes the zoomed image where it is, third click restores thumbnail.
